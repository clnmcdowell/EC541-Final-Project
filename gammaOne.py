...
# Output to show the statistical results
print("An example of the output of the simulator for the case γ = 1 is shown below."
...
plt.scatter(ALPHA_VALUES, mean, marker='x', color='tab:green', s=70, label='Simulation')

plt.title('Comparison of analytical and simulation results for Gamma = 1.000')
...
plt.legend()
plt.tight_layout()
plt.savefig('results_gamma1.png', dpi=300)
plt.show()

print("\nFigure saved as 'results_gamma1.png'.")
